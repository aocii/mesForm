    ...
    if (typeof window === "object") {
        ...
        Factory.prototype = {
            ...
            _swapItems: function (item1, item2) {
                ...
                if (!item2.classList.contains("dragcontent"))
                    return;
                if (parent1 !== parent2) {
                    // move to new list 
                    return;
            ...
            _makeDragItem: function (item) {
                ...
                this._dragItem.style["height"] = (item.offsetHeight || 0) + "px";
                this._dragItem.style["line-height"] = (item.style.lineHeight || item.offsetHeight || 0) + "px";
            ...
            // on item press/drag 
            _onPress: function (e) {
                if (e && e.target && e.target.classList.contains("dragable") && e.target.closest(".dragcontent") && e.target.closest(".dragcontent").parentNode === this._container) {
                    e.preventDefault();

                    this._dragging = true;
                    this._click = getPoint(e);
                    this._makeDragItem(e.target.closest(".dragcontent"));
                    this._onMove(e);
                }
            },
            ...
            _onRelease: function (e) {
                ...
                this._trashDragItem(this._dragItem);
                if (this._dragging && this._options.onAfterRelease)
                    this._options.onAfterRelease();
                this._dragging = false;
            },
        ...
        $.fn.qualistsortable = function (options) {
            options = $.extend({}, $.fn.qualistsortable.options, options);

            return this.each(function () {
                new Factory(this, options);
            });
        };
